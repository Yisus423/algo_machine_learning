...
# X: todas las columnas EXCEPTO 'Survived' (la columna con la cual entrenar del modelo)
x = df.drop('Survived', axis=1)

# y: solo la columna 'Survived' (lo que queremos predecir: 0 = murió, 1 = sobrevivió)
y = df['Survived']
